    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <a className="nav-link active" aria-current="page" href="/">{props.titles1}</a>
        </li>
        <li className="nav-item">
      ...
      {/* text-light use for llight color in dark mode enabled */}
...
Navbar.propTypes={
    ...
    titles1: PropTypes.string
}
Navbar.defaultProps={
    titles: 'set default titles here',
    titles1: 'About homes'
}